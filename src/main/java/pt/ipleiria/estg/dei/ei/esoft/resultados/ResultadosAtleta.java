...
public class ResultadosAtleta extends JFrame{
    ...
    public ResultadosAtleta(String title){
        super(title);
    ...
    public static void abrirPaginasResultadosAtletas(){
        new Resultados("Resultados Atleta").setVisible(true);
    }
